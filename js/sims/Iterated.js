...
function Iterated(config){
	...
	// LABELS
if (self.slideIndex == 3 || self.slideIndex == 4 || self.slideIndex == 5) {
	console.log('Im here bitch!');
	var _l1 = _makeLabel("label_you_cooperate_1", {x:220, y:20, rotation:0, align:"center", color:"#333333", size:20, width:250, lineHeight:1});
	self.dom.appendChild(_l1);
	var _l2 = _makeLabel("label_they_cooperate", {x:272, y:35, rotation:-45, align:"center", color:"#333333", size:15, width:70, lineHeight:1});
	...
	var _l4 = _makeLabel("label_you_cheat_1", {x:224, y:83, rotation:0, align:"left", color:"#333333", size:20, width:250, lineHeight:1});
	self.dom.appendChild(_l4);
}
	////Yasaman Added
	if (self.slideIndex == 6 || self.slideIndex == 7 || self.slideIndex == 8){
	var _l1 = _makeLabel("label_you_cooperate_2", {x:220, y:20, rotation:0, align:"center", color:"#333333", size:20, width:250, lineHeight:1});
	self.dom.appendChild(_l1);
	var _l2 = _makeLabel("label_they_cooperate", {x:272, y:35, rotation:-45, align:"center", color:"#333333", size:15, width:70, lineHeight:1});
	self.dom.appendChild(_l2);
	var _l3 = _makeLabel("label_they_cheat", {x:406, y:86, rotation:45, align:"center", color:"#333333", size:15, width:70, lineHeight:1});
	self.dom.appendChild(_l3);
	var _l4 = _makeLabel("label_you_cheat_2", {x:224, y:83, rotation:0, align:"left", color:"#333333", size:20, width:250, lineHeight:1});
	self.dom.appendChild(_l4);
}
if (self.slideIndex == 9 || self.slideIndex == 10 || self.slideIndex == 11){
	var _l1 = _makeLabel("label_you_cooperate_3", {x:220, y:20, rotation:0, align:"center", color:"#333333", size:20, width:250, lineHeight:1});
	self.dom.appendChild(_l1);
	var _l2 = _makeLabel("label_they_cooperate", {x:272, y:35, rotation:-45, align:"center", color:"#333333", size:15, width:70, lineHeight:1});
	self.dom.appendChild(_l2);
	var _l3 = _makeLabel("label_they_cheat", {x:406, y:86, rotation:45, align:"center", color:"#333333", size:15, width:70, lineHeight:1});
	self.dom.appendChild(_l3);
	var _l4 = _makeLabel("label_you_cheat_3", {x:224, y:83, rotation:0, align:"left", color:"#333333", size:20, width:250, lineHeight:1});
	self.dom.appendChild(_l4);
}
//if (self.slideIndex == 12 || self.slideIndex == 13 || self.slideIndex == 14){

	var _l1 = _makeLabel("label_you_cooperate_4", {x:220, y:20, rotation:0, align:"center", color:"#333333", size:20, width:250, lineHeight:1});
	self.dom.appendChild(_l1);
	/*var _l2 = _makeLabel("label_they_cooperate", {x:272, y:35, rotation:-45, align:"center", color:"#333333", size:15, width:70, lineHeight:1});
	self.dom.appendChild(_l2);
	var _l3 = _makeLabel("label_they_cheat", {x:406, y:86, rotation:45, align:"center", color:"#333333", size:15, width:70, lineHeight:1});
